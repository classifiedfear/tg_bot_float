...
from tg_bot_float_telegram_app.tg_constants import UNSUBSCRIBE_TEXT


class DeleteSubscriptionRouterController(AbstractTGRouterController):
    def __init__(self, handler_service: DeleteSubscriptionHandler) -> None:
        super().__init__()
    ...
    def _init_routes(self) -> None:
        ...
        self._router.message.register(
            ...
            lambda message: message.text == UNSUBSCRIBE_TEXT,
        )
        self._router.message.register(
            self._cancel,

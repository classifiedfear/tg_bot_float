...
from tg_bot_float_common_dtos.update_db_scheduler_dtos.agent_relations_dto import AgentRelationsDTO
...
class SourceDataTreeDTO(BaseModel):
    ...
    glove_relations: List[GloveRelationsDTO]
    agent_relations: List[AgentRelationsDTO]

...
class SkinRouter:
    ...
    def _init_routes(self):
        ...
        self._router.add_api_route(
            "/id/{skin_id}", self._delete_skin_by_id, methods=["DELETE"]
        )
        self._router.add_api_route(
    ...
    async def _create(
        self, service_factory: BOT_DB_SERVICE_FACTORY, skin_dto: SkinDTO,
    ...
    async def _update_skin_by_id(
        self, service_factory: BOT_DB_SERVICE_FACTORY, skin_id: int, skin_dto: SkinDTO,
        ) -> MsgResponseDTO | SkinModel:
        async with service_factory:
            skin_service = service_factory.get_skin_service()
            try:
    ...
    async def _get_skin_by_name(
        ...
        async with service_factory:
            ...
            return MsgResponseDTO(status=False, msg=ITEM_NOT_EXIST_MSG.format(
                item='Skin',
                identifier='name',
                item_identifier=skin_name))

    async def _update_skin_by_name(
        self, service_factory: BOT_DB_SERVICE_FACTORY, skin_name: str, skin_dto: SkinDTO,
        ) -> MsgResponseDTO | SkinModel:
        async with service_factory:
            skin_service = service_factory.get_skin_service()
            try:
    ...
    async def _get_all(self, service_factory: BOT_DB_SERVICE_FACTORY) -> MsgResponseDTO | List[SkinModel]:
        skin_service = service_factory.get_skin_service()

...
from tg_bot_float_common_dtos.csgo_database_source_dtos.weapons_page_response_dto import (
    WeaponsPageResponseDTO,
)
...
class WeaponsPageService(AbstractPageService):
    ...
    def _get_sorted_weapon_names_response(self, weapon_names: List[str]) -> WeaponsPageResponseDTO:

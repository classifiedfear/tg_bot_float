...
class SkinsPageService(AbstractPageService):
    ...
    async def get_skin_names(self, item_name: str) -> SkinsPageDTO:
        ...
        if skin_names and skin_names[0] == "Vanilla":
            return SkinsPageDTO(weapon_name=item_name, skins=skin_names[1:])
        return SkinsPageDTO(weapon_name=item_name, skins=skin_names)
